  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-4 sm:left-10 w-3 h-3 sm:w-4 sm:h-4 bg-blue-400 rounded-full animate-ping"></div>
        <div className="absolute top-40 right-8 sm:right-20 w-4 h-4 sm:w-6 sm:h-6 bg-teal-400 rounded-full animate-pulse delay-1000"></div>
        <div className="absolute bottom-20 left-1/4 w-2 h-2 sm:w-3 sm:h-3 bg-indigo-400 rounded-full animate-bounce delay-2000"></div>
        <div className="absolute top-1/3 right-1/4 w-3 h-3 sm:w-5 sm:h-5 bg-blue-400 rounded-full animate-ping delay-500"></div>
        <div className="absolute bottom-1/3 right-1/4 w-3 h-3 sm:w-4 sm:h-4 bg-teal-400 rounded-full animate-pulse delay-1500"></div>
      </div>
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="text-center space-y-6 sm:space-y-8">
          ...
          <div className="h-12 sm:h-16 flex items-center justify-center px-4">
            <h2 className={`text-lg sm:text-2xl md:text-3xl lg:text-4xl font-light drop-shadow-lg text-center transition-colors duration-300 ${
